    ...
    <div>
      <div className="flex ml-5 mr-5 ">
         ...
         <div className='w-[60%] md:w-[40%] lg:w-[40%] pt-6 pb-6 '>
            <input type='search' placeholder='Search your book' className='outline-none h-6 md:h-10 lg:h-10 placeholder:text-xs placeholder:pl-4 focus:border-slate-200 border-slate-200 border-[1px] rounded w-[100%]'/>
         </div>
